...
class HorizontalBarChart extends ImplicitlyAnimatedWidget {
  ...
  @override
  HorizontalBarChartState createState() => HorizontalBarChartState();
}

class HorizontalBarChartState extends AnimatedWidgetBaseState<HorizontalBarChart> {
  ...
  HorizontalBarChartData _withTouchedIndicators(HorizontalBarChartData barChartData) {
  ...
  Size _getChartSize() {
    if (_chartKey.currentContext != null) {
      ...
      return getDefaultSize(MediaQuery.of(context).size);
    }
  }
