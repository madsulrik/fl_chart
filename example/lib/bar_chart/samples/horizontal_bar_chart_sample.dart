...
class HorizontalBarChartSampleState extends State<HorizontalBarChartSample> {
                  ...
                  child: HorizontalBarChart(
                    HorizontalBarChartData(
                      ...
                      gridData: FlGridData(
                          ...
                          getDrawingVerticalLine: (i) => FlLine(color: Colors.white12)),
  ...
  BarChartGroupData makeGroupData(int value, double v1, double v2) {
    return BarChartGroupData(barsSpace: 0, x: value, barRods: [
      BarChartRodData(
        y: v1,
        color: leftBarColor,
        width: width,
        ...
        backDrawRodData:
            BackgroundBarChartRodData(y: 15, color: Colors.amber.withOpacity(0.2), show: true),
      ),
      BarChartRodData(
        y: v2,
        color: rightBarColor,
